...
@interface FestivalData : NSObject {
    ...
    NSMutableDictionary * sessionsDict; //session.event_key maps to session
    NSMutableDictionary* datesDict; //dates map to sessions in that date
    NSMutableDictionary* sessionsAtDateAndTime; //date-time map to session.event_keys in that date-time
    ...
    NSMutableDictionary* orderOfInsertedDatesDict; //numbers map to dates...nums start from 0 and increment
    NSMutableDictionary* locationColorDict;
    NSMutableArray* EVENT_COLORS_ARRAY;
    NSMutableDictionary* currentUserSessions; //keys = session.event_key and value = @"YES"
}
